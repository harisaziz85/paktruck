...
@Component({
  selector: 'app-wheeltractoe',
  standalone: false,
  
  templateUrl: './wheeltractoe.component.html',
  styleUrl: './wheeltractoe.component.css'
})
export class WheeltractoeComponent {
flatBedTrucks: any[] = [];
           ...
           this.flatBedTrucks = response.data
             .filter(ad => {
               ...
               return (
                 ...
                 ad.subCategory?.trim().toLowerCase() === 'wheel tractor' // Corrected subcategory
               );
             })
             .map(ad => ({
