...
@Component({
  selector: 'app-trailertruck',
  standalone: false,
  
  templateUrl: './trailertruck.component.html',
  styleUrl: './trailertruck.component.css'
})
export class TrailertruckComponent {
flatBedTrucks: any[] = [];
          ...
          this.flatBedTrucks = response.data
            .filter(ad => {
              ...
              return (
                ...
                ad.subCategory?.trim().toLowerCase() === 'trailer truck' // Corrected subcategory
              );
            })
            .map(ad => ({
