...
@Component({
  selector: 'app-threshers',
  standalone: false,
  
  templateUrl: './threshers.component.html',
  styleUrl: './threshers.component.css'
})
export class ThreshersComponent {
 flatBedTrucks: any[] = [];
              ...
              this.flatBedTrucks = response.data
                .filter(ad => {
                  ...
                  return (
                    ...
                    ad.subCategory?.trim().toLowerCase() === 'threshers' // Corrected subcategory
                  );
                })
                .map(ad => ({
