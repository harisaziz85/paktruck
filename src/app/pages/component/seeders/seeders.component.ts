...
@Component({
  selector: 'app-seeders',
  standalone: false,
  
  templateUrl: './seeders.component.html',
  styleUrl: './seeders.component.css'
})
export class SeedersComponent {
  flatBedTrucks: any[] = [];
                ...
                this.flatBedTrucks = response.data
                  .filter(ad => {
                    ...
                    return (
                      ...
                      ad.subCategory?.trim().toLowerCase() === 'seeders' // Corrected subcategory
                    );
                  })
                  .map(ad => ({
