...
@Component({
  selector: 'app-drillingmachine',
  standalone: false,
  
  templateUrl: './drillingmachine.component.html',
  styleUrl: './drillingmachine.component.css'
})
export class DrillingmachineComponent {
  flatBedTrucks: any[] = [];
             ...
             this.flatBedTrucks = response.data
               .filter(ad => {
                 ...
                 return (
                   ...
                   ad.subCategory?.trim().toLowerCase() === 'drilling machine' // Corrected subcategory
                 );
               })
               .map(ad => ({
