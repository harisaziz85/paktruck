...
@Component({
  selector: 'app-cargolandingtruck',
  standalone: false,
  
  templateUrl: './cargolandingtruck.component.html',
  styleUrl: './cargolandingtruck.component.css'
})
export class CargolandingtruckComponent {
              ...
              this.flatBedTrucks = response.data
                .filter(ad => {
                  ...
                  return (
                    ...
                    ad.subCategory?.trim().toLowerCase() === 'cargo landing truck' // Corrected subcategory
                  );
                })
                .map(ad => ({
