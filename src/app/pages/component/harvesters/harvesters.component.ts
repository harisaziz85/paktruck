...
@Component({
  selector: 'app-harvesters',
  standalone: false,
  
  templateUrl: './harvesters.component.html',
  styleUrl: './harvesters.component.css'
})
export class HarvestersComponent {
 flatBedTrucks: any[] = [];
               ...
               this.flatBedTrucks = response.data
                 .filter(ad => {
                   ...
                   return (
                     ...
                     ad.subCategory?.trim().toLowerCase() === 'harvesters' // Corrected subcategory
                   );
                 })
                 .map(ad => ({
