...
@Component({
  selector: 'app-forlliftoperator',
  standalone: false,
  
  templateUrl: './forlliftoperator.component.html',
  styleUrl: './forlliftoperator.component.css'
})
export class ForlliftoperatorComponent {
  flatBedTrucks: any[] = [];
              ...
              this.flatBedTrucks = response.data
                .filter(ad => {
                  ...
                  return (
                    ...
                    ad.subCategory?.trim().toLowerCase() === 'forklift operator' // Corrected subcategory
                  );
                })
                .map(ad => ({
