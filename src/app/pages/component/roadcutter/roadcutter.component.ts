...
@Component({
  selector: 'app-roadcutter',
  standalone: false,
  
  templateUrl: './roadcutter.component.html',
  styleUrl: './roadcutter.component.css'
})
export class RoadcutterComponent {
 flatBedTrucks: any[] = [];
            ...
            this.flatBedTrucks = response.data
              .filter(ad => {
                ...
                return (
                  ...
                  ad.subCategory?.trim().toLowerCase() === 'road cutter' // Corrected subcategory
                );
              })
              .map(ad => ({
