...
@Component({
  selector: 'app-boxtruck',
  standalone: false,
  
  templateUrl: './boxtruck.component.html',
  styleUrl: './boxtruck.component.css'
})
export class BoxtruckComponent {
              ...
              this.flatBedTrucks = response.data
                .filter(ad => {
                  ...
                  return (
                    ...
                    ad.subCategory?.trim().toLowerCase() === 'box truck' // Corrected subcategory
                  );
                })
                .map(ad => ({
