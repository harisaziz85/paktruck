...
@Component({
  selector: 'app-loaderoperator',
  standalone: false,
  
  templateUrl: './loaderoperator.component.html',
  styleUrl: './loaderoperator.component.css'
})
export class LoaderoperatorComponent {
  flatBedTrucks: any[] = [];
                     ...
                     this.flatBedTrucks = response.data
                       .filter(ad => {
                         ...
                         return (
                           ...
                           ad.subCategory?.trim().toLowerCase() === 'loader operator' // Corrected subcategory
                         );
                       })
                       .map(ad => ({
