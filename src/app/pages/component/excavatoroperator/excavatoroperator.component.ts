...
@Component({
  selector: 'app-excavatoroperator',
  standalone: false,
  
  templateUrl: './excavatoroperator.component.html',
  styleUrl: './excavatoroperator.component.css'
})
export class ExcavatoroperatorComponent {
     flatBedTrucks: any[] = [];
                    ...
                    this.flatBedTrucks = response.data
                      .filter(ad => {
                        ...
                        return (
                          ...
                          ad.subCategory?.trim().toLowerCase() === 'excavator operator' // Corrected subcategory
                        );
                      })
                      .map(ad => ({
