...
@Component({
  selector: 'app-tankertruck',
  standalone: false,
  
  templateUrl: './tankertruck.component.html',
  styleUrl: './tankertruck.component.css'
})
export class TankertruckComponent {
flatBedTrucks: any[] = [];
          ...
          this.flatBedTrucks = response.data
            .filter(ad => {
              ...
              return (
                ...
                ad.subCategory?.trim().toLowerCase() === 'tanker truck' // Corrected subcategory
              );
            })
            .map(ad => ({
