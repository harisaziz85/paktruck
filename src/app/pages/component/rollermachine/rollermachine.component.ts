...
@Component({
  selector: 'app-rollermachine',
  standalone: false,
  
  templateUrl: './rollermachine.component.html',
  styleUrl: './rollermachine.component.css'
})
export class RollermachineComponent {
   flatBedTrucks: any[] = [];
                      ...
                      this.flatBedTrucks = response.data
                        .filter(ad => {
                          ...
                          return (
                            ...
                            ad.subCategory?.trim().toLowerCase() === 'roller machine' // Corrected subcategory
                          );
                        })
                        .map(ad => ({
